...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!process.env.EMAIL_PASS) {
      throw new Error("EMAIL_PASS environment variable is missing.");
    }

    if (!process.env.RECIPIENT_EMAIL) {
      throw new Error("RECIPIENT_EMAIL environment variable is missing.");
    }
    ...
    const mailOptions = {
      ...
      // Allows the recipient to hit Reply and reply to the customer
      replyTo: email,
      ...
      html: `
        ...
        >
          ...
          <p
            ...
            "
          >
            This email was sent automatically from the Step By Step Club
