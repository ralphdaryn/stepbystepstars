...
const MommyandMe = () => {
  ...
  // ✅ DYNAMIC SESSIONS
  const remainingSessions2026 = useMemo(() => {
    const sessions = [
      { start: new Date("2026-01-05"), end: new Date("2026-02-12") },
      { start: new Date("2026-02-16"), end: new Date("2026-03-27") },
      { start: new Date("2026-03-30"), end: new Date("2026-05-15") },
      { start: new Date("2026-05-18"), end: new Date("2026-06-26") },
      { start: new Date("2026-06-29"), end: new Date("2026-07-31") },
      { start: new Date("2026-08-03"), end: new Date("2026-09-04") },
      { start: new Date("2026-09-07"), end: new Date("2026-10-16") },
      { start: new Date("2026-10-19"), end: new Date("2026-11-20") },
      { start: new Date("2026-11-23"), end: new Date("2026-12-18") },
    ];

    const today = new Date();

    return sessions
      .filter((session) => session.end >= today)
      .map(
        (session) =>
          `${session.start.toLocaleString("en-US", {
            month: "short",
            day: "numeric",
          })} - ${session.end.toLocaleString("en-US", {
            month: "long",
            day: "numeric",
          })}`
      );
  ...
  // ✅ NEXT SESSION AUTO
  const nextSession = remainingSessions2026[0];
