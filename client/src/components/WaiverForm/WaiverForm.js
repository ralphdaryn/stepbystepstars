      ...
      <div className="waiver-content">
        ...
        <ol>
          <li>
            ...
            participating in group fitness classes provided by Step By Step Club
            Inc. I understand that the activities may include exercises that
            involve strength, flexibility, cardiovascular conditioning,
            climbing, jumping, and other fitness components.
          </li>
          <li>
            <strong>Assumption of Risk:</strong> I understand that participating
            in physical exercise, including but not limited to aerobic and
            anaerobic activities, can be physically demanding. I agree to assume
            full responsibility for any risk of injury, damage, or harm that may
          ...
          <li>
            ...
            allowed to participate in the fitness classes, I hereby release and
            discharge Step By Step Club Inc., its owners, members, officers, and
          ...
          <li>
            <strong>Photograph and Video Release:</strong> I grant Step By Step
            Club Inc. permission to use photographs or videos taken during class
