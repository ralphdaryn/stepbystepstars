...
//   const [showNavigation, setShowNavigation] = useState(false);
//   const [activeLink, setActiveLink] = useState("");
//   const [showBirthdayPartiesDropdown, setShowBirthdayPartiesDropdown] = useState(false);
//   const [showFitnessDropdown, setShowFitnessDropdown] = useState(false);
...
//             <li className="header__navigation-link">
//               <span onClick={() => toggleDropdown("birthdayParties")}>
//                 Birthday Parties {showBirthdayPartiesDropdown ? <FaArrowDown /> : <FaArrowRight />}
//               </span>
//               {showBirthdayPartiesDropdown && (
//                 <ul className="header__navigation-dropdown">
//                   <li><Link to="/danceparty" onClick={() => handleLinkClick("Dance Party")}>Dance Party</Link></li>
//                   <li><Link to="/facepaint" onClick={() => handleLinkClick("Face Painting")}>Face Painting</Link></li>
//                   <li><Link to="/musicalbabies" onClick={() => handleLinkClick("Musical Babies")}>Musical Babies</Link></li>
//                 </ul>
//               )}
//             </li>
//             <li className="header__navigation-link">
...
//               {showFitnessDropdown && (
//                 <ul className="header__navigation-dropdown">
//                   <li><Link to="/mommyandme" onClick={() => handleLinkClick("Mommy and Me")}>Mommy and Me</Link></li>
//                   <li><Link to="/groupfitness" onClick={() => handleLinkClick("Group Fitness")}>Group Fitness</Link></li>
//                   <li><Link to="/privatetraining" onClick={() => handleLinkClick("Private Training")}>Private Training</Link></li>
//                 </ul>
//               )}
//             </li>
...
//             <li className="header__sidebar-link">
//               <span onClick={() => toggleDropdown("birthdayParties")}>
//                 Birthday Parties {showBirthdayPartiesDropdown ? <FaArrowRight /> : <FaArrowDown />}
//               </span>
//               {showBirthdayPartiesDropdown && (
//                 <ul className="header__sidebar-dropdown">
//                   <li><Link to="/danceparty" onClick={() => handleLinkClick("Dance Party")}>Dance Party</Link></li>
...
//             <li className="header__sidebar-link">
//               <span onClick={() => toggleDropdown("fitness")}>
//                 Fitness {showFitnessDropdown ? <FaArrowRight /> : <FaArrowDown />}
//               </span>
//               {showFitnessDropdown && (
//                 <ul className="header__sidebar-dropdown">
//                   <li><Link to="/mommyandme" onClick={() => handleLinkClick("Mommy and Me")}>Mommy and Me</Link></li>
//                   <li><Link to="/groupfitness" onClick={() => handleLinkClick("Group Fitness")}>Group Fitness</Link></li>
//                   <li><Link to="/privatetraining" onClick={() should_handle_LinkClick("Private Training")}>Private Training</Link></li>
//                 </ul>
//               )}
//             </li>
...
//               <Link to="/events">Events <FaArrowRight /></Link>
//             </li>
//             <li className="header__sidebar-link" onClick={() should_handle_LinkClick("Contact")}>
//               <Link to="/contact">Contact <FaArrowRight /></Link>
//             </li>
//           </ul>
//           <ul className="header__sidebar-icons">
//             <li className="header__sidebar-facebook"><a href="https://facebook.com/stepbystepstars"><FaFacebook size={35} /></a></li>
//             <li className="header__sidebar-instagram"><a href="https://instagram.com/stepbystepstars"><FaInstagramSquare size={35} /></a></li>
//           </ul>
//           <div className="header__sidebar-footer">
//             <p className="header__sidebar-text">Step By Step © 2024</p>
//           </div>
